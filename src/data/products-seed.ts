...
/**
 * One-time seed data. The live catalog now lives in the `products` table
 * (editable from /admin) — this array is only inserted into the database
 * the first time it's empty, so the storefront isn't blank on day one.
 */
